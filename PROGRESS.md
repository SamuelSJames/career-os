...
| AWS Adv. Networking – Specialty (ANS-C01) | Pass | Y3 | Not started | ⬜ |
| Red Hat Ansible cert (EX374) | OPTIONAL — decide Y3 | Y3 | Deferred | ◻️ optional |
| Git & GitHub | Mastered | Y1 | Using daily for this mission | 🟦 |
| GitHub projects | Multiple | all | 1 (career-os) | 🟦 |
| Documented labs | 50+ | all | 0 | ⬜ |
| Educational videos | ~150 (52/yr) | all | 0 | ⬜ |
| Automation capstone | Ansible + Terraform + CI/CD | Y2 Q4 | Not started | ⬜ |
| Flagship capstone | Hybrid network + AWS, IaC/CI-CD | Y3 Q3 | Not started | ⬜ |
| Land SA role | Customer-facing AWS SA | Y3 Q4 | — | ⬜ |
| Architect mindset | Yes | ongoing | Developing | 🟦 |

## Video Counter
- **Year 1:** 0 / 52
- **Year 2:** 0 / 52
- **Year 3:** 0 / 52
- **Total:** 0 / ~156 _(holiday-aware pace — see ROADMAP; charter asked 100+, we'll exceed)_
...
## Milestone Log
- **2026-06-26** — Career OS initialized; mission, roadmap, trackers scaffolded; repo created.
